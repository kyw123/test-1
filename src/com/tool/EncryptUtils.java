...
public class EncryptUtils {
	 ...
	 * 测试  @param args
	 */
	public static final String  a= "kuangyaweikuangy";
...
//		String source = a;
//		String str11 = encryptUtils.encryptToAES(source, "128128");
//		System.out.println("AES加密后为:" + str11);
//		// 使用这个密匙解密
//		String str12 = encryptUtils.decryptByAES(source, str11);
//		System.out.println("AES解密后为：" + str12);
//		// DES加密后为:D6B7F58022D8417BB9C02475835E0BAB
//		// DES解密后为：128128
		
		/**通过des的密钥进行加解密*/
		EncryptUtils en = new  EncryptUtils();
		String decryptByDES = en.encryptToDES(key, "128128");
		System.out.println("Des进行加密:"+decryptByDES);
		String decryptByDES2 = en.decryptByDES(key, decryptByDES);
		System.out.println("Des进行解密:"+decryptByDES2);
	}
	/**
	 * 进行MD5加密
	 * @param info 要加密的信息

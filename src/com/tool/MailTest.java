...
public class MailTest {  
    ...
    /***
		asvtwnvaujrqdjgj  POP3的授权密码。
		xuhcixhovdopcgde  IMAP/SMTP服务授权密码。
		
		注意：邮箱如果报了javax.mail.AuthenticationFailedException:failed to connect的话。
		表示。qq邮箱里的POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务未开启动。所以需要。开启才能使用。
     */
    //idojbwmeixjwbjgd
    private String[] to;  
    ...
    public static void main(String args[]) {  
        ...
        mail.setSubject("这个一个关于公示内部的结构文档。请阅读文章");  
